 ...
 * @description     [由ros message恢复出gridmap]
 * @param message
 * @param gridMap
 * @return
 */
...
/**
 * @function        [toMessage]
 * @description     [将gridmap转换为ros message]
 * @param gridMap
 * @param message
 */
 ...
 * @function            [toPointCloud]
 * @description         [将gridmap转换为PCL点云]
 * @param gridMap       [要转换的地图]
 * @param layers        [哪几层地图要转换为pointcloud]
 * @param pointLayer    [将该层的cell值作为点云的z轴坐标值
 *                       其他层的cell值作为点云的一些附属特性，如颜色之类的]
 * @param pointCloud    [最后要生成的点云]
 */
void GridMapRosConverter::toPointCloud(const grid_map::GridMap& gridMap,
